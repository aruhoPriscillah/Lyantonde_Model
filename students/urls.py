...
urlpatterns = [
    ...
    path("requirements/", views.requirements_register, name="requirements_register"),
    path("requirements/export/", views.export_requirements_register, name="export_requirements_register"),
